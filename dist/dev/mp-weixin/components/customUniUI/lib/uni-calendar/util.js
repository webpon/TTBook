"use strict";
var components_customUniUI_lib_uniCalendar_calendar = require("./calendar.js");
class Calendar {
  constructor({
    date,
    selected,
  ...
  getlunar(year, month, date) {
    return components_customUniUI_lib_uniCalendar_calendar.calendar.solar2lunar(year, month, date);
  }
